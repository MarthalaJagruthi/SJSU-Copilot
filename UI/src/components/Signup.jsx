    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0F172A] p-4">
      <div className="w-full max-w-5xl bg-[#1E293B] rounded-2xl shadow-2xl flex overflow-hidden">
        ...
        <div className="w-full md:w-1/2 p-10 md:p-12 flex flex-col justify-center">
          ...
          <p className="text-[#94A3B8] text-sm mb-8">Kindly fill in your details to create an account</p>

          <form onSubmit={handleSubmit} className="space-y-5">
            {/* Full Name */}
            <div>
              <label className="block text-[#94A3B8] text-xs font-medium mb-1.5">Your fullname*</label>
              <input
                type="text"
                value={fullName}
          ...
          {/* Google */}
          <button className="w-full flex items-center justify-center gap-3 bg-[#0F172A] hover:bg-[#1a2744] border border-[#334155] text-white font-medium py-3 rounded-lg transition-colors">
          ...
          <p className="text-center text-[#94A3B8] text-sm mt-6">
            ...
            <button onClick={onSwitchToLogin} className="text-[#E5A823] hover:text-[#D49612] font-medium transition-colors">
              Login
            </button>
          </p>
        </div>
        ...
        <div className="hidden md:block w-1/2 p-4">
          <div className="w-full h-full rounded-xl overflow-hidden bg-gradient-to-br from-[#0055A2] via-[#0055A2]/80 to-[#E5A823]/60 flex items-center justify-center">
            <div className="text-center p-8">
              ...
              <h2 className="text-white text-3xl font-bold mb-3">Join SJSU Copilot</h2>
